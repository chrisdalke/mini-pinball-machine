...
clang -framework CoreVideo -framework IOKit -framework Cocoa -framework GLUT -framework OpenGL lib/raylib_mac/libraylib_mac.a lib/chipmunk_mac/libchipmunk_mac.a main.c physicsDebugDraw.c constants.c inputManagerMac.c -o game_mac -L./lib/chipmunk_mac -I./lib/chipmunk_mac -I./lib/raylib_mac -L/opt/local/lib -lcurl -lssl -lcrypto -lssl -lcrypto -lz
./game_mac
